<template>
    <div>
        ...
        <defs>
            <radialGradient id="radial-gradient-back" cx="513.66" cy="116.66" fx="513.66" fy="116.66" r="712.14" gradientTransform="translate(0 94.3) scale(1 .19)" gradientUnits="userSpaceOnUse">
            <stop offset="0" stop-color="#363636"/>
            <stop offset="1" stop-color="#000"/>
            </radialGradient>
            <radialGradient id="radial-gradient-back-2" cx="513.66" cy="116.66" fx="513.66" fy="116.66" r="372.46" gradientUnits="userSpaceOnUse">
...
.cls-2 {
    fill: url(#radial-gradient-back);
    mix-blend-mode: overlay;
    stroke: url(#radial-gradient-back-2);
